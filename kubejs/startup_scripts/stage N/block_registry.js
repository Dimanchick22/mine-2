StartupEvents.registry('block', event => {
    // Gribony
    event.create('gribtweaks:gribony_block')
    .soundType('metal')
    .hardness(50)
    ...
    event.create('gribtweaks:unstable_gribony_block')
    .soundType('metal')
    .hardness(10)
    ...
    event.create('gribtweaks:pre_gribony_block')
    .soundType('metal')
    .hardness(25)
    ...
    .requiresTool(true)
    // stage 6
    event.create('gribtweaks:protasteel_block')
    .soundType('metal')
    .hardness(5)
    ...
    event.create('gribtweaks:rocket_covering')
    .soundType('metal')
    .hardness(5)
    ...
    event.create('gribtweaks:reinforced_ludicrite_block')
    .soundType('metal')
    .hardness(10)
    ...
    event.create('gribtweaks:reinforced_covering')
    .soundType('stone')
    .hardness(0.8)
    ...
    event.create('gribtweaks:advanced_covering')
    .soundType('stone')
    .hardness(0.8)
    ...
    event.create('gribtweaks:ultra_covering')
    .soundType('stone')
    .hardness(0.8)
    ...
    event.create('gribtweaks:life_essence_block')
    .material('metal')
    .hardness(1.5)
    ...
    event.create('gribtweaks:osmium_ore')
    .soundType('stone')
    .hardness(3)
    ...
    event.create('gribtweaks:deepslate_osmium_ore')
    .soundType('stone')
    .hardness(4)
    .displayName('Осмиевоносная глубинная руда') 
    .tagBlock('minecraft:mineable/pickaxe') 
    .tagBlock('minecraft:needs_iron_tool')
    .tag('forge:ores')
    .requiresTool(true)

    event.create('gribtweaks:block_osmium')
    .soundType('metal')
    .hardness(5)
    ...
    event.create('gribtweaks:witch_ore')
    .soundType('stone')
    .hardness(3)
    ...
    event.create('gribtweaks:witch_ingot_block')
    .soundType('metal')
    .hardness(5)
